import { addTrack, deleteTrack, hasTrack, listArtists, removeDuplicates } from './ozans-playlist';
...
describe('listArtists', () => {
  ...
  xtest('works for a non-empty playlist', () => {
    const playlist = ['Onu Alma Beni Al - Sezen Aksu', 'Famous Blue Raincoat - Leonard Cohen', 'Rakkas - Sezen Aksu'];
