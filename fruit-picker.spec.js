...
describe('task 2', () => {
  xtest('onError should call notify with an error message', () => {
...
describe('task 3', () => {
  xtest('order from grocer passes callback function arguments forward', () => {
...
describe('task 4', () => {
  xtest('postOrder composes a request to the grocer using the defined callbacks', () => {
